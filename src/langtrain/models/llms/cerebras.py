...
from langtrain.datasets.prompt_dataset import PromptDataset

from langtrain.models.llms.hf_transformer import HFTransformer
...
def run_on_dataset(
    ...
    for batch in tqdm(train_loader):
        ...
        for i in range(len(output_ids)):
            # Multiply the attention mask by the input ids to get zero out the
            # padding tokens
